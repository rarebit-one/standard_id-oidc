module StandardId
  module Oidc
    module Extensions
      ...
      # StandardId::Oidc::RevokedToken. Core says so itself — access tokens
      ...
      # StandardId::Oidc::Engine), and the reason the gemspec pins
      ...
      module IntrospectionsControllerExt
        ...
        def decode_token(token)
          ...
          jti = payload[:jti]
          return nil if jti.present? && StandardId::Oidc::RevokedToken.revoked?(jti)
